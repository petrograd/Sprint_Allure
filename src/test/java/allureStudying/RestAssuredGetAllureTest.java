...
public class RestAssuredGetAllureTest {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MmRmYWQwNDA3YmViODAwM2Q3ZTViMzUiLCJpYXQiOjE2NjMzMjkzMjIsImV4cCI6MTY2MzkzNDEyMn0.vivAfzvHbP9u368b5qA3nidgQTG1mfOOAnc_Qikzvhw";
    ...
    public void checkUserName() {
        given()
                .auth().oauth2(bearerToken)
                .get("/api/users/me")
                .then().assertThat().body("data.name",equalTo("Игорь Иванович"));
    }
